...
files = ["ant1.3", "arc", "poi1.5", "redktor", "tomcat", "velocity1.4", "Xalan2.4", "xerces1.2"]
...
for index in range(len(files)):
  ...
  for ind in range(20):
    ...
    for i in range(k):
      ...
      D = len(temp_df[temp_df['bug']==1])
      nd = len(temp_df[temp_df['bug']==-1])
      r = D/len(temp_df)
      if r > p:
        chosendf = temp_df[temp_df['bug']==1]
      else:
        chosendf = temp_df[temp_df['bug']==-1]
